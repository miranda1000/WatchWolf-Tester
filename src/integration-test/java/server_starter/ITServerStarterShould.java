...
@ExtendWith(ITServerStarterShould.class)
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class ITServerStarterShould extends AbstractTest {
    ...
    public String getConfigFile() {
        return "src/integration-test/java/server_starter/resources/basic.yaml";
    }
    ...
    public void startupSucceeded() throws Exception {
        ITServerStarterShould tis = (ITServerStarterShould) AbstractTest.getInstance(this.getClass());
