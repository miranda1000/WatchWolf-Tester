...
@ExtendWith(ITPluginDownloaderShould.class)
public class ITPluginDownloaderShould extends AbstractTest {

    @Override
    public String getConfigFile() {
        return "src/integration-test/java/plugin_downloader/resources/config.yaml";
    }

    @ParameterizedTest
    @ArgumentsSource(ITPluginDownloaderShould.class)
